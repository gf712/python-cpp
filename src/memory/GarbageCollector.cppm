...
export class GarbageCollector
{
  public:
	...
	void remove_weakref(Heap &heap, std::uint8_t *obj) const;

	void set_frequency(std::size_t new_frequency) { m_frequency = new_frequency; }

  protected:
	std::size_t m_frequency;
};

export class MarkSweepGC : public GarbageCollector
{
  public:
	MarkSweepGC();
  ...
  private:
	...
	mutable std::uint8_t *m_stack_bottom{ nullptr };
	std::size_t m_iterations_since_last_sweep{ 0 };
	bool m_pause{ false };
};
