...
export module py.runtime:type_error;
...
class TypeError : public Exception
{
	...
	friend BaseException *make_type_error(std::string &&);
...
// Defined in TypeError.cpp. Keeping the PyString/PyTuple construction and the
...
{
	return make_type_error(std::vformat(message, std::make_format_args(args...)));
}
