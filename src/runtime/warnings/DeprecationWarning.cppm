...
export module py.runtime:deprecation_warning;
import :warning;
...
class DeprecationWarning : public Warning
{
	...
	friend BaseException *make_deprecation_warning(std::string &&);
...
// Defined in warnings/DeprecationWarning.cpp. Keeping the PyString/PyTuple construction and the
...
{
	return make_deprecation_warning(std::vformat(message, std::make_format_args(args...)));
}
