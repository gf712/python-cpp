...
export module py.runtime:resource_warning;
import :warning;
...
class ResourceWarning : public Warning
{
	...
	friend BaseException *make_resource_warning(std::string &&);
...
// Defined in warnings/ResourceWarning.cpp. Keeping the PyString/PyTuple construction and the
...
{
	return make_resource_warning(std::vformat(message, std::make_format_args(args...)));
}
