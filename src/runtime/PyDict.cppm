...
class PyDictItemsIterator : public PyBaseObject
{
	...
	PyDictItemsIterator(const PyDictItems &pydict_items, std::size_t position);
...
class PyDictKeyIterator : public PyBaseObject
{
	...
	PyDictKeyIterator(const PyDictKeys &pydict_keys, std::size_t position);
...
class PyDictValueIterator : public PyBaseObject
{
	...
	PyDictValueIterator(const PyDictValues &pydict_values, std::size_t position);
